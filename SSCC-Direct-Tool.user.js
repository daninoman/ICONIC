// ==UserScript==
// @name         SSCC Direct Tool
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Directs stock to ASRS/Picktower and integrates QA Label Printing.
// @author       daninoman
// @match        https://oms-live-au.zalora.net/inbound/inbound-by-barcode*
// @match        https://script.google.com/a/macros/theiconic.com.au/s/AKfycby7rNzPXxlIkewaVqTrv3vBG3JWRWZ6Bb6qDAxsSrYWG6_s2-iidU_Af8Ei1PmnStmvTQ/exec*
// @match        https://*.googleusercontent.com/*
// @grant        window.close
// @run-at       document-end
// @updateURL    https://raw.githubusercontent.com/daninoman/ICONIC/main/SSCC-Direct-Tool.user.js
// @downloadURL  https://raw.githubusercontent.com/daninoman/ICONIC/main/SSCC-Direct-Tool.user.js
// ==/UserScript==
...
(function() {
    ...
    if (window.location.href.includes("zalora.net")) {
        setInterval(() => {
            ...
            btn.innerHTML = '📦 SSCC DIRECT TOOL';
            ...
            printWin.document.write(`
                ...
                <head>
                    <style>
                        ...
                        .label { width: 76mm; height: 36mm; padding: 1.5mm 3mm; box-sizing: border-box; page-break-after: always; overflow: hidden; }
                        .info-line { font-size: 9pt; margin-bottom: 1pt; white-space: nowrap; }
                        .write-line { font-size: 10pt; margin-top: 5pt; }
                        .header { font-size: 13pt; font-weight: bold; border-bottom: 1pt solid black; margin-bottom: 3pt; text-align: center; }
